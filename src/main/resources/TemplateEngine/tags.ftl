        ...
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <ul class="nav navbar-nav">
                    <li>
                        <form role="tagSearch" class="navbar-form" id="tagSearch">
                            <div class="form-group">
                                <input type="text" id=searchBar   placeholder="Enter Tags Separated By Colon" name="tagSearch" value=${tag}>
                            </div>
            ...
            <div class="navbar-header col-sm-6 col-md-6">
                ...
                <a href="/tags" class="btn btn-default" style="background-color: #008cc1;">Tag/Genre</a>
...
<div class="row">
    <div class="col-md-5">
        <div class="panel panel-default scrollable-panel" <div class="panel panel-default scrollable-panel" style="max-height: 600;overflow: scroll;">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function tagSearch() {
            var query=$("#tagSearch").find("input[name=tagSearch]").val();
            ...
            $.get("http://ec2-34-241-1-61.eu-west-1.compute.amazonaws.com:8080/tag/"+query,
                    function (data) {
                        ...
                        data.forEach(function (row) {
                            ...
                            $("<tr><td class='song'>" + song.title + "</td><td class='artist'>" + artist.name + "</td></tr>").appendTo(t)
                                    .click(function() { showSong($(this).find("td.song").text(),$(this).find("td.artist").text());
 									showTag($(this).find("td.song").text(),$(this).find("td.artist").text());
