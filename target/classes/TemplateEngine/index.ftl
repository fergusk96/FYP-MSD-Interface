        ...
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <ul class="nav navbar-nav">
                    <li>
                        <form role="movieSearch" class="navbar-form" id="movieSearch">
                            <div class="form-group">
                                <input type="text" value="Matrix" placeholder="Search for Movie Title" class="form-control" name="movieSearch">
                            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#movieSearch").submit(movieSearch);
